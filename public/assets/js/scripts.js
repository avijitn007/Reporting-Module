...
const menuText = document.querySelectorAll('.menu-link');
const menuList = document.querySelectorAll('.menu-list');
const subMenulist = document.querySelector('.sub-menu-list');

// if(!menuList.classList.contains('selected')){
...
sidebarToggle.addEventListener('click', function (e) {
    ...
    sidebarMenu.classList.toggle('cs-sidebar');
    
    if( main.classList.contains('active'))
    {
        logoSmall.classList.remove('hidden');
        logoBig.classList.add('hidden');
        menuText.forEach(item => item.classList.add('hidden'));
        document.querySelector('body').classList.add('closedSidebar');
        subMenulist.classList.add('hidden');
    }
    else{
        logoBig.classList.remove('hidden');
        logoSmall.classList.add('hidden');
        menuText.forEach(item => item.classList.remove('hidden'));
        document.querySelector('body').classList.remove('closedSidebar');
        subMenulist.classList.remove('hidden');
    }
});
...
sidebarOverlay.addEventListener('click', function (e) {
    ...
    sidebarMenu.classList.add('cs-sidebar');
});

sidebarMenu.addEventListener('mouseenter', function () {
    sidebarOverlay.classList.remove('hidden');
    sidebarMenu.classList.remove('cs-sidebar');
    menuText.forEach(item => item.classList.remove('hidden'));
    main.classList.remove('active');
    logoBig.classList.remove('hidden');
    logoSmall.classList.add('hidden');
...
sidebarMenu.addEventListener('mouseleave', function () {
    if(document.querySelector('body').classList.contains('closedSidebar')){
        sidebarOverlay.classList.add('hidden');
        sidebarMenu.classList.add('cs-sidebar');
        menuText.forEach(item => item.classList.add('hidden'));
